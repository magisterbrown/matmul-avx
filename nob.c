...
#define NOB_REBUILD_URSELF(binary_path, source_path) "gcc", "-ggdb", "-o", binary_path, source_path, "-Wl,-rpath,./raylib", "-lraylib", "-Lraylib"
#include "nob.h"
...
void *hot_redrawer()
{
    ...
    nob_cmd_append(&build, "gcc", "-ggdb", "-O0", "-S", "generator.c", "-o", asmf);
